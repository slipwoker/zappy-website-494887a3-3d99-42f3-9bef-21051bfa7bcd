  ...
  if (contactForm) {
    ...
    function clearFieldState(field) {
      ...
      const existingError = field.parentNode.querySelector(
        '#' + ((field.id || field.name || 'field') + '-error') + ', .' + ERROR_MESSAGE_CLASS
      );
      if (existingError && existingError.previousElementSibling === field) {
        existingError.remove();
      }

      const nextSibling = field.nextElementSibling;
      if (nextSibling && nextSibling.classList.contains(ERROR_MESSAGE_CLASS)) {
        nextSibling.remove();
      }
    }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '494887a3-3d99-42f3-9bef-21051bfa7bcd',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '494887a3-3d99-42f3-9bef-21051bfa7bcd';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '494887a3-3d99-42f3-9bef-21051bfa7bcd';
